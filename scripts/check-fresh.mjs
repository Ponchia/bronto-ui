...
assertFresh(artifacts, {
  label: `${Object.keys(artifacts).length} generated artifacts are fresh (tokens.css/json, dtcg, resolved, figma variables, .d.ts, reference/package contract, classes.json, vscode data)`,
