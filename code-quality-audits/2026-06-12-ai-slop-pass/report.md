...
## Security Regression
- RUN: semgrep deep
  - Command: `/Users/zeno/bronto/llm-config/tools/semgrep/scan.sh --preset deep --output code-quality-audits/2026-06-12-ai-slop-pass/semgrep .`
  - Result: PASS
...
- RUN: CodeQL
  - Command: `/Users/zeno/bronto/llm-config/tools/codeql/scan.sh .`
  - Result: PASS
